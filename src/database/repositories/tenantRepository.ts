...
class TenantRepository {
  ...
  static async destroy(id, options: IRepositoryOptions) {
    ...
    await Election(options.database).deleteMany({ tenant: id }, options);

    await Association(options.database).deleteMany({ tenant: id }, options);

    await NewsCategory(options.database).deleteMany({ tenant: id }, options);

    await NewsTag(options.database).deleteMany({ tenant: id }, options);

    await News(options.database).deleteMany({ tenant: id }, options);

    await Partner(options.database).deleteMany({ tenant: id }, options);

    await Group(options.database).deleteMany({ tenant: id }, options);

    await Formule(options.database).deleteMany({ tenant: id }, options);

    await Membership(options.database).deleteMany({ tenant: id }, options);

    await Campaign(options.database).deleteMany({ tenant: id }, options);
